					...
					<form method="post" action="ExecuteUpdateFilmServlet" novalidate="novalidate" >
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<input type="hidden" name="film.id" id="film.id" class="form-control" value="${update_film_attr.id }">
							</div>
						...
						<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary">Conferma</button>
						 <a href="ExecuteListFilmServlet" class='btn  btn-outline-primary' style='width:80px'>
