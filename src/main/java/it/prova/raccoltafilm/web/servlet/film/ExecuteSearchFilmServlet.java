...
public class ExecuteSearchFilmServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String dataDiPubblicazioneParam = request.getParameter("dataPubblicazione");
		String registaIdParam = request.getParameter("regista.id");
		
		Film example = UtilityForm.createFilmFromParams(titoloParam, genereParam, durataParam, dataDiPubblicazioneParam, registaIdParam);
